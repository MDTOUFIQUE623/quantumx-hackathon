...
async function loadModule() {
  ...
  const modulePath = isDeno
    ? `../../../../dist/classic-mceliece-6688128f.deno.js`
    : `../../../../dist/classic-mceliece-6688128f.min.js`;
...
/**
 * CLASSIC-MCELIECE-6688128F-INFO algorithm constants and metadata
 * @type {{readonly name: 'Classic-McEliece-6688128f', readonly identifier: 'Classic-McEliece-6688128f', readonly type: 'kem', readonly securityLevel: 5, readonly standardized: false, readonly description: string, readonly keySize: {readonly publicKey: 1044992, readonly secretKey: 13932, readonly ciphertext: 208, readonly sharedSecret: 32}}}
 */
 ...
 * @example
 * import { createClassicMcEliece6688128f } from '@oqs/liboqs-js';
...
export class ClassicMcEliece6688128f {
   ...
   * @returns {typeof CLASSIC_MCELIECE_6688128F_INFO} Algorithm metadata (copy of CLASSIC_MCELIECE_6688128F_INFO)
   * @example
   * const info = kem.info;
