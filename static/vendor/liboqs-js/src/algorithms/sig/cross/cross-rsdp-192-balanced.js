...
/**
 * CROSS-RSDP-192-BALANCED-INFO algorithm constants and metadata
 * @type {{readonly name: 'CROSS-rsdp-192-balanced', readonly identifier: 'CROSS-rsdp-192-balanced', readonly type: 'sig', readonly securityLevel: 3, readonly standardized: false, readonly description: string, readonly keySize: {readonly publicKey: 115, readonly secretKey: 48, readonly signature: 29853}}}
 */
 ...
 *
 * @example
 * import { createCrossRsdp192Balanced } from '@oqs/liboqs-js';
 *
...
export class CrossRsdp192Balanced {
   ...
   * @returns {Uint8Array} Signature (variable length, max 29853 bytes)
   * @throws {LibOQSError} If instance is destroyed
   ...
   *
   * @readonly
   * @returns {typeof CROSS_RSDP_192_BALANCED_INFO} Algorithm metadata
   *
   * @example
