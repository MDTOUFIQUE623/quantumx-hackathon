...
/**
 * CROSS-RSDP-256-SMALL-INFO algorithm constants and metadata
 * @type {{readonly name: 'CROSS-rsdp-256-small', readonly identifier: 'CROSS-rsdp-256-small', readonly type: 'sig', readonly securityLevel: 5, readonly standardized: false, readonly description: string, readonly keySize: {readonly publicKey: 153, readonly secretKey: 64, readonly signature: 50818}}}
 */
 ...
 *
 * @example
 * import { createCrossRsdp256Small } from '@oqs/liboqs-js';
 *
...
export class CrossRsdp256Small {
   ...
   *
   * @readonly
   * @returns {typeof CROSS_RSDP_256_SMALL_INFO} Algorithm metadata
   *
   * @example
