...
async function loadModule() {
  ...
  const modulePath = isDeno
    ? `../../../../dist/cross-rsdpg-128-balanced.deno.js`
    : `../../../../dist/cross-rsdpg-128-balanced.min.js`;
...
/**
 * CROSS-RSDPG-128-BALANCED-INFO algorithm constants and metadata
 * @type {{readonly name: 'CROSS-rsdpg-128-balanced', readonly identifier: 'CROSS-rsdpg-128-balanced', readonly type: 'sig', readonly securityLevel: 1, readonly standardized: false, readonly description: string, readonly keySize: {readonly publicKey: 54, readonly secretKey: 32, readonly signature: 9120}}}
 */
 ...
 *
 * @example
 * import { createCrossRsdpg128Balanced } from '@oqs/liboqs-js';
 *
...
export class CrossRsdpg128Balanced {
   ...
   * @returns {Uint8Array} Signature (variable length, max 9120 bytes)
   * @throws {LibOQSError} If instance is destroyed
   ...
   *
   * @readonly
   * @returns {typeof CROSS_RSDPG_128_BALANCED_INFO} Algorithm metadata
   *
   * @example
