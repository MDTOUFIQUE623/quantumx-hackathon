...
/**
 * SNOVA-24-5-4-INFO algorithm constants and metadata
 * @type {{readonly name: 'SNOVA-24-5-4', readonly identifier: 'SNOVA_24_5_4', readonly type: 'sig', readonly securityLevel: 1, readonly standardized: false, readonly description: string, readonly keySize: {readonly publicKey: 1016, readonly secretKey: 48, readonly signature: 248}}}
 */
 ...
 *
 * @example
 * import { createSnova2454 } from '@oqs/liboqs-js';
 *
...
export class Snova2454 {
   ...
   *
   * @readonly
   * @returns {typeof SNOVA_24_5_4_INFO} Algorithm metadata
   *
   * @example
